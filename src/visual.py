...
class Ui_SRI(object):
    def setupUi(self, SRI):
        ...
        self.label_4.setGeometry(QtCore.QRect(560, 70, 41, 16))
        ...
        self.label_6.setGeometry(QtCore.QRect(560, 140, 111, 16))
        ...
        self.sensitive.setGeometry(QtCore.QRect(680, 140, 16, 17))
    ...
    def retranslateUi(self, SRI):
        ...
        self.label.setText(_translate("SRI", "Information Retrieval System"))
        self.label_2.setText(_translate("SRI", "DataSet"))
        self.label_3.setText(_translate("SRI", "Limit"))
        self.label_4.setText(_translate("SRI", "Umbral"))
        self.label_5.setText(_translate("SRI", "alpha"))
        self.label_6.setText(_translate("SRI", "Case sensitive search"))
